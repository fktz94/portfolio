...
export default function Proyect() {
  ...
  const cardStyles = {
    figureStyle:
      'my-4 max-w-[400px] min-h-[256px] sm:w-[46%] bg-[color:var(--grey-color)] hover:scale-110 hover:bg-[color:var(--black-color)] hover:text-[color:var(--secondary-color)] transition duration-150',
